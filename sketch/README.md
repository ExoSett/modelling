...
The application asks for the number of accommodation-frame cells wide (1–20) and high (1–10). It can arrange one pair, two pairs facing across a gap of 0–3 accommodation-module depths, or four equal pairs around a square quadrangle. A zero-width gap uses one shared service frame. Sketch supports mouse and touch inspection, can save or reload XML, and can download the current view as a PNG. A single optional front-facade style can be applied to every accommodation-frame cell for quick visual studies.
